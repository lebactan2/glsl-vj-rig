...
// layer categories (background/patterns/objects/misc) from vj/categorize_layers.js, if present
let CATEGORY = {};
try { CATEGORY = JSON.parse(fs.readFileSync(path.join(__dirname, "layer_categories.json"), "utf8")); } catch (e) {}
const bundle =
  ...
  "window.LAYER_CATEGORY = " + JSON.stringify(CATEGORY) + ";\n";

/* @layer_metadata
{
  "title": "Shader: IMG_3922",
  "layers": [
    {
      "name": "Background",
      "keywords": ["yellow", "sweep", "light", "blue", "edge", "animation"]
    },
    {
      "name": "Text Letters",
      "keywords": ["text", "red", "letters", "pulse", "sdf", "hand-written"]
    },
    {
      "name": "Food Picture",
      "keywords": ["food", "picture", "bowl", "noodles", "steam", "animation"]
    }
  ]
}
*/

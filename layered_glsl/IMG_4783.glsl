/* @layer_metadata
{
  "title": "Shader: IMG_4783",
  "layers": [
    {
      "name": "Wall",
      "keywords": ["wall", "white", "blue", "panel"]
    },
    {
      "name": "Floor",
      "keywords": ["floor", "tiled", "reflection", "sweeping"]
    },
    {
      "name": "TV",
      "keywords": ["tv", "painting", "screen", "flicker", "animation"]
    },
    {
      "name": "Plant",
      "keywords": ["plant", "pot", "leaves", "swaying"]
    },
    {
      "name": "Furniture",
      "keywords": ["furniture", "table", "legs", "cloth", "black"]
    },
    {
      "name": "Figure",
      "keywords": ["figure", "black", "gold", "pattern", "animation"]
    },
    {
      "name": "Grid Borders",

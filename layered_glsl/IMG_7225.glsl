/* @layer_metadata
{
  "title": "Shader: IMG_7225",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "shadow"]
    },
    {
      "name": "Box Base",
      "keywords": ["box", "green", "noise", "bevel", "edges", "red"]
    },
    {
      "name": "Text NHANG",
      "keywords": ["text", "nhang", "gold", "typography"]
    },
    {
      "name": "Text THAN TAI",
      "keywords": ["text", "than", "tai", "yellow"]
    },
    {
      "name": "Gold Seal",
      "keywords": ["gold", "seal", "ornate", "dragon", "motif"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Shader: IMG_2450",
  "layers": [
    {
      "name": "Background",
      "keywords": ["paper", "texture", "background"]
    },
    {
      "name": "Head Structure",
      "keywords": ["head", "outline", "hair", "brain", "veins", "heart", "animation", "ear"]
    },
    {
      "name": "Label Texts",
      "keywords": ["label", "text", "scribble", "title", "lines"]
    }
  ]
}
*/

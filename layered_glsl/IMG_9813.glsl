/* @layer_metadata
{
  "title": "Shader: IMG_9813",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "brushed", "metal", "reflections"]
    },
    {
      "name": "Main Graphics",
      "keywords": ["graphics", "characters", "repeating", "black"]
    },
    {
      "name": "Text Opening Hours",
      "keywords": ["text", "opening", "hours"]
    },
    {
      "name": "Bottom Text Logos",
      "keywords": ["bottom", "text", "logos"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]

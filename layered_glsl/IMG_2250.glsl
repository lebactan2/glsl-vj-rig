/* @layer_metadata
{
  "title": "Shader: IMG_2250",
  "layers": [
    {
      "name": "Ceiling",
      "keywords": ["ceiling", "top"]
    },
    {
      "name": "Stone Base",
      "keywords": ["stone", "base", "floor", "ledge", "pattern"]
    },
    {
      "name": "Lattice Wall",
      "keywords": ["lattice", "wall", "brick", "curve", "sky", "clouds", "animation", "shadow"]
    },
    {
      "name": "Side Pillars",
      "keywords": ["side", "pillars", "railing", "blue"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Blue Plastic Chair Pattern",
  "layers": [
    {
      "name": "Background",
      "keywords": ["dark", "grey", "background", "behind"]
    },
    {
      "name": "Frame",
      "keywords": ["plastic", "blue", "curved", "backrest", "boundary", "bevel"]
    },
    {
      "name": "Mesh",
      "keywords": ["mesh", "diamond", "holes", "pattern", "diagonal", "threads"]
    },
    {
      "name": "Floral Design",
      "keywords": ["flower", "floral", "petals", "center", "stems", "leaves", "branch"]
    },
    {
      "name": "Lighting",
      "keywords": ["lighting", "specular", "highlight", "top-down", "shiny"]
    }
  ]
}
*/

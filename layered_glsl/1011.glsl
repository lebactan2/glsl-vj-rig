...
@layer_metadata
{
  "title": "Woven Blue Folding Chair",
  "layers": [
    {"name": "Background", "keywords": ["background", "floor", "wall", "tiles", "stone", "grey", "beige", "brown", "brick"]},
    {"name": "Chair Shadow", "keywords": ["shadow", "dark", "chair shadow"]},
    {"name": "Woven Chair", "keywords": ["chair", "folding chair", "woven", "fabric", "blue", "metallic", "frame", "silver"]}
  ]
}
*/
...
void layer_Background(in vec2 p, inout vec3 col) {
    ...
    col = vec3(0.6, 0.6, 0.6); // Grey stone floor
...
void layer_WovenChair(in vec2 p, inout vec3 col) {

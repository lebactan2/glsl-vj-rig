/* @layer_metadata
{
  "title": "Shader: IMG_1721",
  "layers": [
    {
      "name": "Background Wall",
      "keywords": ["wall", "background", "siding"]
    },
    {
      "name": "Bottom Stone",
      "keywords": ["stone", "bottom", "background"]
    },
    {
      "name": "Top Trim",
      "keywords": ["trim", "top", "dark", "animation"]
    },
    {
      "name": "Strep Text",
      "keywords": ["text", "strep"]
    },
    {
      ...
      "keywords": ["character", "cartoon", "body", "head", "eyes", "mouth", "arms", "animation"]
    }
  ]
}
*/

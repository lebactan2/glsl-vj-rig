/* @layer_metadata
{
  "title": "Shader: IMG_0419",
  "layers": [
    {
      "name": "Green Tiles",
      "keywords": ["green", "tiles", "pavement", "grout", "squares"]
    },
    {
      "name": "Bumpy Line",
      "keywords": ["bumpy", "line", "middle", "pebbles", "grid"]
    },
    {
      "name": "Street Wall",
      "keywords": ["street", "wall", "background"]
    },
    {
      "name": "Distance Fade",
      "keywords": ["distance", "fade", "perspective"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Shader: IMG_0995",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "wall", "plaster", "texture"]
    },
    {
      "name": "Balcony Wall",
      "keywords": ["balcony", "wall", "teal", "gradient"]
    },
    {
      "name": "Clothesline",
      "keywords": ["clothesline", "clothes", "shirts", "hanging", "sway", "animation"]
    },
    {
      "name": "Bird Cage",
      "keywords": ["bird", "cage", "bamboo", "hook"]
    },
    {
      "name": "Plant",
      "keywords": ["plant", "pot", "vines", "leaves", "terracotta"]
    }
  ]
}
*/

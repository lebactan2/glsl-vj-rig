/* @layer_metadata
{
  "title": "Shader: IMG_1151",
  "layers": [
    {
      "name": "Road",
      "keywords": ["road", "asphalt", "background", "texture"]
    },
    {
      "name": "Motorcycle Parts",
      "keywords": ["motorcycle", "tail light", "red", "license plate", "pulse", "animation"]
    },
    {
      "name": "Trousers Leg",
      "keywords": ["trousers", "pants", "leg", "pattern", "floral", "fabric", "fold", "animation"]
    },
    {
      "name": "Foot And Shoe",
      "keywords": ["foot", "shoe", "brown", "leather", "shine"]
    }
  ]
}
*/

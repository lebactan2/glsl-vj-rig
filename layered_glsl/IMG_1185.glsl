/* @layer_metadata
{
  "title": "Shader: IMG_1185",
  "layers": [
    {
      "name": "Wooden Floor",
      "keywords": ["wood", "floor", "planks", "grain", "background"]
    },
    {
      "name": "Main Body Wrapped",
      "keywords": ["motorcycle", "cardboard", "box", "tape", "text", "red", "blue"]
    },
    {
      "name": "Front Wheel",
      "keywords": ["wheel", "tire", "rim", "spokes", "silver"]
    },
    {
      "name": "Back Part Wrapping",
      "keywords": ["wrapping", "paper", "white", "blue", "pattern", "tape"]
    }
  ]
}
*/

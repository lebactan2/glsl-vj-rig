/* @layer_metadata
{
  ...
  "layers": [
    {
      "name": "Background",
      "keywords": ["ticket", "pink", "gradient", "pattern"]
    },
    {
      "name": "Blue Edges",
      "keywords": ["blue", "edges", "yellow", "dots", "stars"]
    },
    {
      "name": "Red Numbers",
      "keywords": ["red", "numbers", "digits"]
    },
    {
      "name": "Deity Figure",
      "keywords": ["deity", "gold", "halo", "robes", "coins", "ingots"]
    },
    {
      "name": "Text Overlay",
      "keywords": ["text", "overlay", "red", "bars"]
    },
    {
      "name": "Top Section",
      "keywords": ["top", "date", "logo", "stamp"]
    }
  ]
}
*/

  ...
  "layers": [
    {
      ...
      "keywords": ["structure", "nodes", "beams", "grid", "holes"]
    },
    {
      "name": "Pallet Material",
      "keywords": ["plastic", "pallet", "yellow-green", "bevel", "texture"]
    },
    {
      "name": "Background Holes",
      "keywords": ["holes", "background", "dark", "underneath"]
    }
  ]
}
*/

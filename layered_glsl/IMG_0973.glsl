/* @layer_metadata
{
  "title": "Shader: IMG_0973",
  "layers": [
    {
      "name": "Outer Wall",
      "keywords": ["wall", "outer", "grey", "texture"]
    },
    {
      "name": "Dark Background",
      "keywords": ["background", "dark", "behind gate"]
    },
    {
      "name": "Floor",
      "keywords": ["floor", "perspective", "moving", "tiles", "animation"]
    },
    {
      "name": "Gate",
      "keywords": ["gate", "bars", "circles", "pattern", "metallic", "animation"]
    },
    {
      "name": "Objects",
      "keywords": ["objects", "red", "blue", "pulse", "animation"]
    }
  ]
}
*/

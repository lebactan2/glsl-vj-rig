/* @layer_metadata
{
  "title": "Shader: IMG_6574",
  "layers": [
    {
      "name": "Sky",
      "keywords": ["sky", "gradient"]
    },
    {
      "name": "Trees",
      "keywords": ["trees", "swaying", "animation", "noise"]
    },
    {
      "name": "Ground",
      "keywords": ["ground", "dots", "animation"]
    },
    {
      "name": "Poles",
      "keywords": ["poles", "shading"]
    },
    {
      "name": "Windows",
      "keywords": ["windows", "blue"]
    },
    {
      "name": "Moto",
      "keywords": ["moto", "animation", "wheels", "body", "fairing", "tail", "pipe"]
    },
    {
      "name": "Noise",
      "keywords": ["noise", "overlay"]
    }
  ]
}
*/

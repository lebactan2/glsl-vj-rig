/* @layer_metadata
{
  "title": "Shader: IMG_0967",
  "layers": [
    {
      "name": "Brick Wall",
      "keywords": ["brick", "wall", "red", "texture", "surrounding"]
    },
    {
      "name": "Window Slats",
      "keywords": ["window", "slats", "blinds", "animation", "reflection", "light"]
    },
    {
      "name": "Window Frames",
      "keywords": ["window", "frames", "vertical", "center"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette", "shadow", "edge"]
    }
  ]
}
*/

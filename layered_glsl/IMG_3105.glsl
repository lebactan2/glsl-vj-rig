/* @layer_metadata
{
  "title": "Shader: IMG_3105",
  "layers": [
    {
      "name": "Sky",
      "keywords": ["sky", "clouds", "trees", "animation"]
    },
    {
      "name": "Roof Behind",
      "keywords": ["roof", "behind"]
    },
    {
      "name": "Cat",
      "keywords": ["cat", "fur", "eyes", "tail", "animation"]
    },
    {
      "name": "Main Wall",
      "keywords": ["wall", "texture", "grungy", "peeling", "paint", "shadow"]
    },
    {
      "name": "Exposed Brick",
      "keywords": ["brick", "broken", "wall", "mortar", "dirt"]
    }
  ]
}
*/

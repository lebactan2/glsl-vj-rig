/* @layer_metadata
{
  "title": "Shader: IMG_4742",
  "layers": [
    {
      "name": "Street",
      "keywords": ["street", "scroll", "noise"]
    },
    {
      "name": "Person",
      "keywords": ["person", "body", "legs", "clothes", "hat", "shoes", "animation"]
    },
    {
      "name": "Bags",
      "keywords": ["bags", "basket", "plaid", "swing"]
    },
    {
      "name": "Motorcycle",
      "keywords": ["motorcycle", "headlight"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Shader: IMG_1061",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "pink", "pattern"]
    },
    {
      "name": "Red Bar",
      "keywords": ["red bar", "text", "gold", "shine", "animation"]
    },
    {
      "name": "Text 2K4",
      "keywords": ["text", "2K4", "red", "outline"]
    },
    {
      "name": "God Of Wealth",
      "keywords": ["god", "wealth", "figure", "gold", "red", "green", "glimmer"]
    },
    {
      "name": "Bottom Numbers",
      "keywords": ["numbers", "bottom", "red", "grid"]
    },
    {
      "name": "Dark Edges",
      "keywords": ["dark", "edges", "brown", "fabric", "texture"]
    }
  ]
}
*/

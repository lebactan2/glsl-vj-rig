/* @layer_metadata
{
  "title": "Shader: IMG_5517",
  "layers": [
    {
      "name": "Ground",
      "keywords": ["ground", "arc", "radial", "lines"]
    },
    {
      "name": "Pillar Base",
      "keywords": ["pillar", "base", "tiled", "grout", "specular", "rolling"]
    },
    {
      "name": "Top Column",
      "keywords": ["column", "smooth"]
    },
    {
      "name": "Decorative Tile",
      "keywords": ["decorative", "tile", "flower", "rotating"]
    }
  ]
}
*/

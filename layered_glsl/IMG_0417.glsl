/* @layer_metadata
{
  ...
  "layers": [
    {
      "name": "Mapping",
      "keywords": ["sdf", "base", "pedestal", "stone", "3D"]
    },
    {
      "name": "Background",
      "keywords": ["background", "wall", "floor", "gray"]
    },
    {
      "name": "Lighting",
      "keywords": ["lighting", "normal", "diffuse", "specular"]
    },
    {
      "name": "Materials",
      "keywords": ["materials", "base", "stone", "black", "white"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette", "shadow", "fade"]
    }
  ]
}
*/
...
void layer_MaterialsAndLighting(in vec3 ro, in vec3 rd, in float d, in float iTime, inout vec3 col) {
    if (d < 10.0) {
        vec3 p3 = ro + rd * d;
        vec3 n = getNormal(p3);

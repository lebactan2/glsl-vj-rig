/* @layer_metadata
{
  "title": "Shader: IMG_1725",
  "layers": [
    {
      "name": "Storefront Structure",
      "keywords": ["storefront", "frame", "wood"]
    },
    {
      "name": "Left Display Panel",
      "keywords": ["panel", "menu", "text", "chinese", "animation"]
    },
    {
      "name": "Upper Display Case",
      "keywords": ["display", "case", "horse", "rider", "sky", "water", "mountain", "tree", "animation"]
    },
    {
      "name": "Lower Display Case",
      "keywords": ["display", "case", "people", "scene", "room", "figures", "table"]
    },
    {
      "name": "Curvy Wooden Dividers",
      "keywords": ["dividers", "wood", "curvy", "wavy"]
    },
    {
      "name": "Lower Items",
      "keywords": ["items", "basket", "bowl", "lower"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Shader: IMG_6550",
  "layers": [
    {
      "name": "Background",
      "keywords": ["wall", "pink", "maroon", "trim"]
    },
    {
      "name": "Roof",
      "keywords": ["roof", "tile", "shimmer", "animation"]
    },
    {
      "name": "Symbols",
      "keywords": ["symbol", "maroon"]
    },
    {
      "name": "Gate",
      "keywords": ["gate", "yellow", "metal", "shine", "rotation", "animation"]
    },
    {
      "name": "Fence",
      "keywords": ["fence", "green", "sliding"]
    },
    {
      "name": "Noise",

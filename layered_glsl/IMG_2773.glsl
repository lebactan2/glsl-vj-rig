/* @layer_metadata
{
  "title": "Shader: IMG_2773",
  "layers": [
    {
      "name": "Wall Base",
      "keywords": ["wall", "tile", "red", "texture", "animation"]
    },
    {
      "name": "Awning",
      "keywords": ["awning", "stripes", "perspective", "shadows"]
    },
    {
      "name": "Symbol",
      "keywords": ["symbol", "circle", "yellow", "yin-yang", "trigram", "nodes", "pulse"]
    },
    {
      "name": "Leaves Overlay",
      "keywords": ["leaves", "overlay", "wind", "shadows", "animation"]
    }
  ]
}
*/

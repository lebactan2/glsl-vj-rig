/* @layer_metadata
{
  "title": "Shader: IMG_1308",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "paper", "texture"]
    },
    {
      "name": "Head",
      "keywords": ["head", "hair", "outline", "ink"]
    },
    {
      "name": "Kite Garment",
      "keywords": ["garment", "kite", "spine", "shoulders", "sleeves", "legs", "ink", "lines"]
    },
    {
      "name": "Shading",
      "keywords": ["shading", "crosshatching", "ink", "animation"]
    },
    {
      "name": "Text Forbes",
      "keywords": ["text", "forbes", "ink", "letters"]
    }
  ]
}
*/

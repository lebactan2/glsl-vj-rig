/* @layer_metadata
{
  "title": "Shader: IMG_1399",
  "layers": [
    {
      "name": "Store Interior",
      "keywords": ["store", "interior", "brick", "wall", "racks", "clothes", "background"]
    },
    {
      "name": "Checkered Floor",
      "keywords": ["floor", "checkered", "perspective", "background"]
    },
    {
      "name": "Main Subject Torso",
      "keywords": ["subject", "torso", "shirt", "striped", "snoopy", "pocket", "collar", "buttons"]
    },
    {
      "name": "Skin Arms Neck",
      "keywords": ["skin", "arms", "neck", "hands"]
    },
    {
      "name": "Shorts",
      "keywords": ["shorts", "striped", "clothing"]
    },
    {
      "name": "Bare Legs",
      "keywords": ["legs", "skin"]
    ...
    {
      "name": "Head",
      "keywords": ["head", "hair", "ears", "face"]
    },
    {
      "name": "Phone",
      "keywords": ["phone", "camera", "reflection", "flash"]
    }
  ]
}
*/

/* @layer_metadata
{
  ...
  "layers": [
    {
      "name": "TiledBox",
      "keywords": ["box", "tiles", "grey", "grout", "stone", "cube"]
    },
    {
      "name": "Pillar",
      "keywords": ["pillar", "concrete", "top", "solid", "grey"]
    },
    {
      "name": "Ground",
      "keywords": ["ground", "floor", "flower", "pattern", "tiles"]
    }
  ]
}
*/
...
void main() {
    ...
    vec3 col = vec3(0.05);
    vec4 b = layer_TiledBox(uv); col = mix(col, b.rgb, b.a);
    vec4 pl = layer_Pillar(uv);  col = mix(col, pl.rgb, pl.a);
    vec4 g = layer_Ground(uv);   col = mix(col, g.rgb, g.a);

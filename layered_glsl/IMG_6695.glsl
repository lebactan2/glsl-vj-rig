/* @layer_metadata
{
  "title": "Shader: IMG_6695",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "blur", "noise", "drifting"]
    },
    {
      "name": "Hat",
      "keywords": ["hat", "white"]
    ...
    {
      "name": "Face",
      "keywords": ["face", "skin", "tone"]
    },
    {
      "name": "Torso",
      "keywords": ["torso", "uniform", "blue", "orange", "collar", "metallic", "sweep"]
    },
    {
      "name": "Arms",
      "keywords": ["arms", "hands", "cuffs"]
    },
    {
      "name": "Pants",
      "keywords": ["pants", "trim"]

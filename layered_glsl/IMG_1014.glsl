/* @layer_metadata
{
  "title": "Shader: IMG_1014",
  "layers": [
    {
      "name": "Floor",
      "keywords": ["floor", "stone", "texture", "background"]
    },
    {
      "name": "Chair",
      "keywords": ["chair", "plastic", "blue", "floral", "cutout", "embossed", "reflection", "animation"]
    },
    {
      "name": "Chair Leg",
      "keywords": ["chair leg", "cylinder", "blue"]
    }
  ]
}
*/

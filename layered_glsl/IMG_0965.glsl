/* @layer_metadata
{
  "title": "Shader: IMG_0965",
  "layers": [
    {
      "name": "Blue Tiles",
      "keywords": ["blue", "tiles", "grout", "background"]
    },
    {
      "name": "Bird",
      "keywords": ["bird", "paper", "shadow", "parallax", "white", "blue details"]
    },
    {
      "name": "Flowers",
      "keywords": ["flower", "cloud", "paper", "shadow", "painted", "green", "yellow"]
    },
    {
      "name": "Small Cloud",
      "keywords": ["cloud", "flower", "small", "white"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Shader: IMG_1348",
  "layers": [
    {
      "name": "Background Walls",
      "keywords": ["background", "walls", "temple"]
    },
    {
      "name": "God Rays",
      "keywords": ["rays", "light", "volumetric", "animation", "window"]
    },
    {
      "name": "Pillar",
      "keywords": ["pillar", "column", "dragon", "relief", "carved", "clouds", "red", "gold"]
    },
    {
      "name": "Headpiece",
      "keywords": ["headpiece", "wood", "grain", "glimmer", "animation", "horns"]
    },
    {
      "name": "Veil And Emblem",
      "keywords": ["veil", "fabric", "face", "eyes", "blink", "mouth", "emblem", "divine eye", "tracking", "animation", "hands", "grip"]
    }
  ]
}
*/

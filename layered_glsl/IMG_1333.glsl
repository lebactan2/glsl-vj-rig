/* @layer_metadata
{
  "title": "Shader: IMG_1333",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "white", "grey", "vignette"]
    },
    {
      "name": "Hood",
      "keywords": ["hood", "head", "face", "hat", "fabric", "wind", "animation"]
    },
    {
      "name": "Raincoat",
      "keywords": ["raincoat", "jacket", "pants", "sleeves", "buttons", "belt", "epaulets", "collar", "texture", "plastic", "flutter", "animation"]
    },
    {
      "name": "Hands",
      "keywords": ["hands", "skin"]
    ...
    {
      "name": "Shoes",
      "keywords": ["shoes", "black", "shine"]
    },
    {
      "name": "Floor",
      "keywords": ["floor", "tiles", "shadow", "background"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Shader: IMG_9812",
  "layers": [
    {
      "name": "Background Wood Panels",
      "keywords": ["background", "wood", "panels", "grain"]
    },
    {
      "name": "Left Objects",
      "keywords": ["picture", "frame", "leather", "trunks"]
    },
    {
      "name": "Bottom Surface",
      "keywords": ["bottom", "surface", "trunk", "rivets"]
    },
    {
      "name": "Center Wood Wheel Object",
      "keywords": ["center", "wood", "wheel", "metal", "rod"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]

/* @layer_metadata
{
  ...
  "layers": [
    ...
    {
      "name": "Shrine Structure",
      "keywords": ["shrine", "roof", "latticework", "interior", "figures", "arch", "railing", "cracks", "weathering", "lighting"]
    },
    {
      "name": "Floor Shadow",
      "keywords": ["shadow", "floor"]
    }
  ]
}
*/

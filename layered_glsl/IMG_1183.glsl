/* @layer_metadata
{
  "title": "Shader: IMG_1183",
  "layers": [
    {
      "name": "Roller Door",
      "keywords": ["roller door", "metal", "grooves", "dirt", "background"]
    },
    {
      "name": "Posters",
      "keywords": ["posters", "paper", "text", "torn", "flutter", "animation"]
    },
    {
      "name": "Scooter",
      "keywords": ["scooter", "handlebar", "plastic", "grip", "shine"]
    }
  ]
}
*/

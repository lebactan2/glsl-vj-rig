/* @layer_metadata
{
  "title": "Shader: IMG_2263",
  "layers": [
    {
      "name": "Background",
      "keywords": ["trees", "sky", "leaves", "animation", "background"]
    },
    {
      "name": "Ground",
      "keywords": ["ground", "asphalt"]
    },
    {
      "name": "Blue Pillar",
      "keywords": ["pillar", "blue", "stone", "sign"]
    },
    {
      "name": "Blue Gate Structure",
      "keywords": ["gate", "blue", "structure", "rings", "pattern", "animation"]
    },
    {
      "name": "Fence",
      "keywords": ["fence", "mesh", "diamond"]
    }
  ]
}
*/

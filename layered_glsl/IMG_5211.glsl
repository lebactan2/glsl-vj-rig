/* @layer_metadata
{
  "title": "Shader: IMG_5211",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "grey", "glass", "reflection", "animation", "line"]
    },
    {
      "name": "Top Reflection",
      "keywords": ["reflection", "white", "blue", "blocks", "swaying"]
    },
    {
      "name": "Leaf",
      "keywords": ["leaf", "green", "veins", "stem", "gold", "decorations", "calligraphy", "grapes", "vines", "trim"]
    },
    {
      "name": "Specular Highlight",
      "keywords": ["specular", "highlight", "glass"]
    }
  ]
}
*/

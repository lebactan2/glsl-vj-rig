/* @layer_metadata
{
  "title": "Shader: IMG_7686",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "wall", "ceiling", "red", "trim"]
    },
    {
      "name": "Lotus Grate",
      "keywords": ["lotus", "grate", "green", "metal"]
    },
    {
      "name": "Foreground Roof",
      "keywords": ["foreground", "roof", "red", "tiles"]
    },
    {
      "name": "Central Ornate Feature",
      "keywords": ["central", "ornate", "finial", "gold", "green", "sphere"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]

/* @layer_metadata
{
  "title": "Shader: IMG_7680",
  "layers": [
    {
      "name": "Sky",
      "keywords": ["sky", "night", "stars", "starfield", "twinkle"]
    },
    {
      "name": "Building",
      "keywords": ["building", "silhouette", "roof"]
    },
    {
      "name": "String Lights",
      "keywords": ["string", "lights", "wire", "bulbs", "glow", "blinking"]
    },
    {
      "name": "Red Lantern",
      "keywords": ["red", "lantern", "pendulum", "swing", "tassel"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]

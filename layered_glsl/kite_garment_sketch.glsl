/* @layer_metadata
{
  "title": "Kite Garment Sketch",
  "layers": [
    {
      "name": "Background",
      "keywords": ["paper", "background", "texture", "grain"]
    },
    {
      "name": "Person Head",
      "keywords": ["head", "person", "sketch"]
    },
    {
      "name": "Shoulders Neck",
      "keywords": ["shoulders", "neck", "lines"]
    },
    {
      "name": "Central Garment Spine",
      "keywords": ["central", "garment", "spine", "line"]
    },
    {
      "name": "Kite Wing Top Edge",
      "keywords": ["kite", "wing", "top", "edge"]
    },
    {
      "name": "Internal Arch Yoke",
      "keywords": ["internal", "arch", "yoke"]
    },
    {
      "name": "Kite Wing Bottom Edge",
      "keywords": ["kite", "wing", "bottom", "edge"]
    },
    {
      "name": "Sleeves",
      "keywords": ["sleeves", "lines"]
    },
    {
      "name": "Legs",
      "keywords": ["legs", "lines"]

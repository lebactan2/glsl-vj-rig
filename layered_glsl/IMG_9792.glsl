/* @layer_metadata
{
  "title": "Shader: IMG_9792",
  "layers": [
    {
      "name": "Sky Trees",
      "keywords": ["sky", "trees", "leaves", "background"]
    },
    {
      "name": "Wall Roof",
      "keywords": ["wall", "roof", "tiles", "brick"]
    },
    {
      "name": "Ground",
      "keywords": ["ground", "dirt", "sand"]
    },
    {
      "name": "Flowers Lamppost",
      "keywords": ["flowers", "pink", "lamppost", "pole"]
    },
    {
      "name": "Rock Cairn",
      "keywords": ["rock", "cairn", "mound", "voronoi"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]

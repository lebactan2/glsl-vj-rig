/* @layer_metadata
{
  "title": "Shader: IMG_1621",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "wall", "cafe", "store front", "ivy", "leaves", "animation"]
    },
    {
      "name": "Floor",
      "keywords": ["floor", "tiles", "perspective", "animation"]
    },
    {
      "name": "Wood Rack",
      "keywords": ["wood", "rack", "display", "carvings", "ornamental"]
    },
    {
      "name": "Chair Table",
      "keywords": ["chair", "table", "green", "background"]
    },
    {
      "name": "Motorcycle",
      "keywords": ["motorcycle", "honda cub", "wheels", "spokes", "red", "seat", "leather", "engine", "exhaust", "pipe", "animation"]
    }
  ]
}
*/

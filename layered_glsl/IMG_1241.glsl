/* @layer_metadata
{
  "title": "Shader: IMG_1241",
  "layers": [
    {
      "name": "Ground",
      "keywords": ["ground", "floor", "texture", "dirt", "grime", "background"]
    },
    {
      "name": "Chair",
      "keywords": ["chair", "seat", "backrest", "legs", "plastic", "wear", "dirt"]
    },
    {
      "name": "License Plate",
      "keywords": ["license plate", "blue", "border", "text", "shimmer", "animation", "string"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette", "darken", "effect"]
    }
  ]
}
*/

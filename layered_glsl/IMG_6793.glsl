/* @layer_metadata
{
  "title": "Shader: IMG_6793",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "white", "vignette"]
    },
    {
      "name": "Casing",
      "keywords": ["casing", "grey", "box"]
    },
    {
      "name": "Screen",
      "keywords": ["screen", "led", "grid", "border", "rgb"]
    },
    {
      "name": "Scrolling Content",
      "keywords": ["scrolling", "logo", "text", "animation"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Shader: IMG_1306",
  "layers": [
    {
      "name": "Background Road",
      "keywords": ["road", "street", "city", "buildings", "trees", "car lights", "background"]
    },
    {
      "name": "Metal Frame",
      "keywords": ["frame", "metal", "bars", "rusty", "grey"]
    },
    {
      "name": "Blue Cloth",
      "keywords": ["cloth", "tarp", "blue", "folds", "wind", "animation", "knot"]
    },
    {
      "name": "Plastic Bags",
      "keywords": ["bags", "plastic", "white", "translucent", "wind", "animation"]
    },
    {
      "name": "Shadows",

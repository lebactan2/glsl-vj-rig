/* @layer_metadata
{
  "title": "Shader: IMG_1300",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "white", "grey"]
    },
    {
      "name": "Vest Body",
      "keywords": ["vest", "tactical", "fabric", "texture", "molle", "webbing", "pads"]
    },
    {
      "name": "Pouches",
      "keywords": ["pouches", "zipper", "pockets"]
    },
    {
      "name": "Arm Attachments",
      "keywords": ["arm", "attachments", "protectors", "straps"]
    },
    {
      "name": "Collar",
      "keywords": ["collar", "hood", "folds", "fabric"]
    },
    {
      "name": "Shadows",

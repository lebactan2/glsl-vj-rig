/* @layer_metadata
{
  "title": "Shader: IMG_1126",
  "layers": [
    {
      "name": "Background",
      "keywords": ["motorcycle", "body", "dark", "background"]
    },
    {
      "name": "Chrome Exhaust",
      "keywords": ["exhaust", "chrome", "silver", "reflection", "shine", "animation"]
    },
    {
      "name": "Suspension Spring",
      "keywords": ["suspension", "spring", "coil", "metal", "highlight"]
    },
    {
      "name": "Carbon Fiber Plates",
      "keywords": ["carbon fiber", "plates", "silver", "texture", "pattern", "animation"]
    }
  ]
}
*/

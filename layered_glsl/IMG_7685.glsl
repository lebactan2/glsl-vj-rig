/* @layer_metadata
{
  "title": "Shader: IMG_7685",
  "layers": [
    {
      "name": "Background Wall",
      "keywords": ["background", "wall", "sky", "roof"]
    },
    {
      "name": "Center Window",
      "keywords": ["center", "window", "vent", "circle", "text"]
    },
    {
      "name": "Balcony Railing",
      "keywords": ["balcony", "railing", "lotus", "metal"]
    },
    {
      "name": "Bottom Red Section",
      "keywords": ["bottom", "red", "section"]
    },
    {
      "name": "Center Post",
      "keywords": ["center", "post", "ornate", "gold"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]

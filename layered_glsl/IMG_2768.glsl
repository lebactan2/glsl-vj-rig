/* @layer_metadata
{
  "title": "Shader: IMG_2768",
  "layers": [
    {
      "name": "Altar Cloth",
      "keywords": ["altar", "cloth", "silk", "shimmer", "folds", "patterns", "characters", "tassels"]
    },
    {
      "name": "Floor",
      "keywords": ["floor", "perspective", "tiles", "mat", "lighting", "flash"]
    },
    {
      "name": "Feet",
      "keywords": ["feet", "bobbing", "toes", "pants"]
    }
  ]
}
*/

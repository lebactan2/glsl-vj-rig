/* @layer_metadata
{
  "title": "Shader: IMG_1323",
  "layers": [
    {
      "name": "Sign Box",
      "keywords": ["sign", "box", "tilted", "yellow", "orange", "border", "red"]
    },
    {
      "name": "Text A LOC",
      "keywords": ["text", "red", "a loc", "glow"]
    },
    {
      "name": "Text CHAO LONG",
      "keywords": ["text", "blue", "chao long", "glow"]
    },
    {
      "name": "Tree Bark",
      "keywords": ["tree", "bark", "background"]
    },
    {
      "name": "Neon Reflections",
      "keywords": ["neon", "reflections", "glow", "background", "animation"]
    }
  ]
}
*/

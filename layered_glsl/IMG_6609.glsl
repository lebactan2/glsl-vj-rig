/* @layer_metadata
{
  "title": "Shader: IMG_6609",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "green", "wavy", "corrugated", "floor", "vignette"]
    },
    {
      "name": "Lattice Panels",
      "keywords": ["lattice", "panels", "shifting", "animation", "frame"]
    },
    {
      "name": "Center Panel",
      "keywords": ["center", "painting", "horse", "person", "flowing", "hair", "cloth"]
    }
  ]
}
*/

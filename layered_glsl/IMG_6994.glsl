/* @layer_metadata
{
  "title": "Shader: IMG_6994",
  "layers": [
    {
      "name": "Floor",
      "keywords": ["floor", "tiles", "panning", "shadow"]
    },
    {
      "name": "Wall",
      "keywords": ["wall", "reflection", "posters", "parallax"]
    },
    {
      "name": "Figure",
      "keywords": ["figure", "walking", "bounce", "box", "arms", "legs", "boots"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]
...
*/
void layer_Floor(in vec2 up_p, in float iTime, inout vec3 col) {
    if (up_p.y < -0.2) {
...
void layer_Wall(in vec2 up_p, in float iTime, inout vec3 col) {
    if (up_p.y >= -0.2) {
...
void layer_Figure(in vec2 up_p, in float iTime, inout vec3 col) {
...
void main() {
    ...
    layer_Floor(up_p, iTime, col);
    layer_Wall(up_p, iTime, col);
    layer_Figure(up_p, iTime, col);

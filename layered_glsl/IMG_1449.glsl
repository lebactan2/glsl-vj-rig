/* @layer_metadata
{
  "title": "Shader: IMG_1449",
  "layers": [
    {
      "name": "Mosaic Wall",
      "keywords": ["mosaic", "wall", "glassy", "tiles", "sparkle", "background"]
    },
    {
      "name": "Gold Frame",
      "keywords": ["frame", "gold", "ornate"]
    },
    {
      "name": "Padding",
      "keywords": ["padding", "leather", "quilted", "silver", "buttons", "diamond"]
    },
    {
      "name": "Wood Frame",
      "keywords": ["frame", "wood", "grain", "center"]
    },
    {
      "name": "Inside Wall",
      "keywords": ["wall", "grungy", "wires", "blue", "black", "exposed"]
    }
  ]
}
*/

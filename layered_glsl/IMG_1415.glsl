/* @layer_metadata
{
  "title": "Shader: IMG_1415",
  "layers": [
    {
      "name": "Runway Background",
      "keywords": ["runway", "background", "gradient", "panels"]
    },
    {
      "name": "Model Shared Features",
      "keywords": ["model", "head", "skin", "hair", "sunglasses", "lips", "arms"]
    },
    {
      "name": "Model Left",
      "keywords": ["model 1", "left", "puffy top", "pants", "belt bag", "animation"]
    },
    {
      "name": "Model Center",
      "keywords": ["model 2", "center", "dress", "parachute", "folds", "wind", "animation"]
    },
    {
      "name": "Model Right",
      "keywords": ["model 3", "right", "cape", "poncho", "skirt", "belt bag"]
    }
  ]
}
*/

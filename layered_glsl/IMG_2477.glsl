/* @layer_metadata
{
  "title": "Shader: IMG_2477",
  "layers": [
    {
      "name": "Background",
      "keywords": ["paper", "base", "texture"]
    },
    {
      "name": "Top Certificate",
      "keywords": ["certificate", "top", "red", "border", "diplome", "stamp", "signature", "animation"]
    },
    {
      "name": "Bottom Certificate",
      "keywords": ["certificate", "bottom", "green", "border", "leaves", "photo", "portrait", "signature", "animation"]
    }
  ]
}
*/

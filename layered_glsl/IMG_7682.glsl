/* @layer_metadata
{
  "title": "Shader: IMG_7682",
  "layers": [
    {
      "name": "Wall",
      "keywords": ["wall", "peeling", "paint", "texture", "weathered"]
    },
    {
      "name": "Window Grille",
      "keywords": ["window", "grille", "lattice", "teal"]
    },
    {
      "name": "Railing",
      "keywords": ["railing", "lotus", "petals", "gold"]
    },
    {
      "name": "Dragon",
      "keywords": ["dragon", "silhouette", "teal"]
    }
  ]
}
*/

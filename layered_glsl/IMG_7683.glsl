/* @layer_metadata
{
  "title": "Shader: IMG_7683",
  "layers": [
    {
      "name": "Background Courtyard",
      "keywords": ["background", "courtyard", "floor", "wall", "plants", "shutters"]
    },
    {
      "name": "Temple Gate Header",
      "keywords": ["temple", "gate", "header", "sign", "gold"]
    },
    {
      "name": "Temple Gate Pillars",
      "keywords": ["temple", "gate", "pillars", "brick", "signs"]
    },
    {
      "name": "Temple Gate Grid",
      "keywords": ["temple", "gate", "grid", "yellow", "metal"]
    },
    {
      "name": "Red Chinese Characters",
      "keywords": ["red", "chinese", "characters"]
    },
    {
      "name": "White Paper Sign",
      "keywords": ["white", "paper", "sign", "text"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]

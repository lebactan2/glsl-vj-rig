/* @layer_metadata
{
  "title": "Shader: IMG_6876",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "white", "lines", "text", "blocks"]
    },
    {
      "name": "Protein",
      "keywords": ["protein", "structure", "pulsating", "rotating", "dots", "flowing"]
    },
    {
      "name": "Zoom Circles",
      "keywords": ["zoom", "circles", "floating", "pink"]
    },
    {
      "name": "Lines",
      "keywords": ["lines", "flowing", "pink"]
    },
    {
      "name": "Vignette",
      "keywords": ["vignette"]

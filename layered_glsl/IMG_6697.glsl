/* @layer_metadata
{
  "title": "Shader: IMG_6697",
  "layers": [
    {
      "name": "Panel",
      "keywords": ["panel", "seams", "dirt", "stains"]
    },
    {
      "name": "Torn Poster",
      "keywords": ["poster", "torn", "edges", "fluttering", "grid"]
    },
    {
      "name": "Top Center Poster",
      "keywords": ["poster", "top", "center", "lightning", "animation"]
    },
    {
      "name": "Stickers",
      "keywords": ["stickers", "green", "blue"]
    }
  ]
}
*/

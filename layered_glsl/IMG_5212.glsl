/* @layer_metadata
{
  "title": "Shader: IMG_5212",
  "layers": [
    {
      "name": "Sky",
      "keywords": ["sky", "blue", "clouds", "animation"]
    },
    {
      "name": "Green Building",
      "keywords": ["building", "green", "netting", "grid"]
    },
    {
      "name": "Crane",
      "keywords": ["crane", "yellow", "swaying", "animation"]
    },
    {
      "name": "White Building",
      "keywords": ["building", "white", "windows", "glass", "glimmer", "sign"]
    },
    {
      "name": "Roof",
      "keywords": ["roof", "brown", "tiles", "texture"]
    },
    {
      "name": "Terrace Walls",
      "keywords": ["walls", "beige", "window", "pergola", "columns"]
    },
    {
      "name": "Terrace Floor",
      "keywords": ["floor", "terrace", "concrete", "perspective", "shadows"]
    },
    {
      "name": "Balustrade",
      "keywords": ["balustrade", "wall", "pillars", "band", "gold", "pattern"]
    }
  ]
}
*/

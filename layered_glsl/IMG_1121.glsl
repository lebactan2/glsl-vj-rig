/* @layer_metadata
{
  "title": "Shader: IMG_1121",
  "layers": [
    {
      "name": "Poster",
      "keywords": ["poster", "dark", "blue", "grey", "red", "car", "text", "abstract"]
    },
    {
      "name": "Street",
      "keywords": ["street", "gravel", "pavement"]
    },
    {
      "name": "Scooter",
      "keywords": ["scooter", "red", "shine", "reflection", "animation"]
    },
    {
      "name": "Rider",
      "keywords": ["rider", "shirt", "grey", "helmet", "white", "mask", "blue", "folds", "fabric"]
    }
  ]
}
*/

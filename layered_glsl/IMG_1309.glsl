/* @layer_metadata
{
  "title": "Shader: IMG_1309",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "white", "studio"]
    },
    {
      "name": "Kite",
      "keywords": ["kite", "diamond", "colors", "paper", "texture", "wind", "animation", "sticks", "bamboo"]
    },
    {
      "name": "Kite Tail",
      "keywords": ["kite", "tail", "brown", "folds", "flap", "animation"]
    },
    {
      "name": "Shadows",
      "keywords": ["shadows", "drop shadow"]
    }
  ]
}
*/

/* @layer_metadata
{
  "title": "Shader: IMG_2148",
  "layers": [
    {
      "name": "Sky",
      "keywords": ["sky", "background"]
    },
    {
      "name": "Road",
      "keywords": ["road", "parallax", "scrolling", "speed", "lines", "dashed"]
    },
    {
      "name": "Buildings",
      "keywords": ["buildings", "parallax", "background", "windows", "shadow"]
    },
    {
      "name": "Power Lines",
      "keywords": ["power lines", "swooping"]
    },
    {
      "name": "Scooter Rider",
      "keywords": ["scooter", "rider", "bouncing", "physics", "headlight", "wheels", "helmet", "jacket"]
    },
    {
      "name": "Bundles",
      "keywords": ["bundles", "bouncing", "bags", "woven", "ropes", "smoke", "exhaust"]
    }
  ]
}
*/

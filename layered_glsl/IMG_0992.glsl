/* @layer_metadata
{
  "title": "Shader: IMG_0992",
  "layers": [
    {
      "name": "Wall",
      "keywords": ["wall", "gradient", "background"]
    },
    {
      "name": "Floor",
      "keywords": ["floor", "perspective", "animated", "panning", "tiles"]
    },
    {
      "name": "Shelves",
      "keywords": ["shelves", "items", "pulse", "left"]
    },
    {
      "name": "Floating Objects",
      "keywords": ["floating", "objects", "purple", "green", "undulating", "animation"]
    }
  ]
}
*/

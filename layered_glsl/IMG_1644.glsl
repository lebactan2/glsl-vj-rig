/* @layer_metadata
{
  "title": "Shader: IMG_1644",
  "layers": [
    {
      "name": "Background",
      "keywords": ["background", "blue", "white"]
    },
    {
      "name": "Text Elements",
      "keywords": ["text", "graphic", "red", "green", "animation"]
    },
    {
      "name": "Top Impact",
      "keywords": ["impact", "hammer", "burst", "falling", "motion lines", "animation"]
    },
    {
      "name": "Bottom Impact",
      "keywords": ["impact", "block", "burst", "falling", "motion lines", "animation"]
    },
    {
      "name": "Hardhat",
      "keywords": ["hardhat", "helmet", "yellow", "safety"]
    },
    {
      "name": "Family Group",
      "keywords": ["family", "father", "mother", "child", "safety"]
    }
  ]
}
*/

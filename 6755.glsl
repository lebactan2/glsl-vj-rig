void main() {
    ...
    if (up_p.y < 0.0) {
        ...
        // Animated light spots passing by
    ...
    vec2 arrP = up_p - vec2(-0.4 + pulse, 0.2); // Animate arrow sliding slightly
